          ...
          >
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
                <AnimatedText className="bg-gradient-to-r from-gray-900 via-blue-800 to-purple-900 
            ...
            >
              ...
              solving complex problems. Proficient in Java, Spring Boot, React, and Node.js, 
              with expertise in data structures and algorithms. Passionate about creating efficient, 
              scalable solutions with expertise in full-stack development.
            </motion.p>
            ...
            >
              ...
              <motion.a
                ...
                className="px-6 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg
                         hover:border-blue-500 dark:hover:border-blue-400 flex items-center gap-2
            ...
            >
              {[
                { icon: Github, href: "https://github.com/Bharadwaj-0203", label: "GitHub" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/bharadwaja-thota-0a6b012bb", label: "LinkedIn" },
                { icon: Mail, href: "mailto:bharadwajathotams@gmail.com", label: "Email" }
